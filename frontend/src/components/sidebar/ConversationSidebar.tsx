  ...
  return (
    <aside className="w-64 bg-[#111318] border-r border-gray-800/60 flex flex-col h-full shrink-0">
      ...
      <div className="px-3 pb-4 pt-1 border-b border-gray-800/60">
        ...
        <Link href="/documents" className={`flex items-center space-x-3 px-3 py-2.5 rounded-xl text-sm transition-colors mb-1 ${isDocuments ? 'bg-[#1a1d27] text-white border border-gray-700/50' : 'text-gray-400 hover:bg-[#1a1d27] hover:text-white border border-transparent'}`}>
            <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
